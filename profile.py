...
portal.context.defineParameter("replica_type", "Replica Hardware Type", portal.ParameterType.STRING, "xl170")
...
portal.context.defineParameter("client_type", "Client Hardware Type", portal.ParameterType.STRING, "xl170")
...
portal.context.defineParameter("control_type", "Control Hardware Type", portal.ParameterType.STRING, "xl170")
