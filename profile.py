...
portal.context.defineParameter("replica_type", "Replica Hardware Type", portal.ParameterType.STRING, "d430")
portal.context.defineParameter("replica_disk_image", "Replica Disk Image", portal.ParameterType.STRING, "urn:publicid:IDN+emulab.us+image+morty-PG0:indicus.node.server")
...
portal.context.defineParameter("client_type", "Client Hardware Type", portal.ParameterType.STRING, "d430")
portal.context.defineParameter("client_disk_image", "Client Disk Image", portal.ParameterType.STRING, "urn:publicid:IDN+emulab.us+image+morty-PG0:indicus.node.server")
...
portal.context.defineParameter("control_type", "Control Hardware Type", portal.ParameterType.STRING, "d430")
